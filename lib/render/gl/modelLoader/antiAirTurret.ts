...
export function buildAntiAirTurretModel(): UnitModel {
  ...
  const barrelSupport = createBoxMesh(0.38, -0.17, 0.46, 0.62, 0.17, 0.62, 4);
  ...
  const muzzleL = createCylinderXMesh(1.18, 1.34, 0.11, 0.56, 0.078, 0.070, 8, 4);
  ...
  const muzzleR = createCylinderXMesh(1.18, 1.34, -0.11, 0.56, 0.078, 0.070, 8, 4);
